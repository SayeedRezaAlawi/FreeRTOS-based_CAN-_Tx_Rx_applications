...
void CAN_Tx_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_Tx_SendMsgT_message
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_Tx_SendMsgT_message(void) 
    {
        ...
        #endif /* CY_PSOC3 || CY_PSOC5 */
            {
                UART_LOG_PutString("My Wife\n");
                result = CAN_Tx_FAIL;
            }
            else
            {
                /* `#START MESSAGE_T_message_TRASMITTED` */
                UART_LOG_PutString("My Son\n");
                CAN_Tx_TX_DATA_BYTE1(0) = CAN_Tx_Data;

                /* `#END` */

                #ifdef CAN_Tx_SEND_MSG_T_message_CALLBACK
                    CAN_Tx_SendMsg_T_message_Callback();
                #endif /* CAN_Tx_SEND_MSG_T_message_CALLBACK */
    ...
    uint8 CAN_Tx_SendMsg1(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                #ifdef CAN_Tx_SEND_MSG_1_CALLBACK
                    CAN_Tx_SendMsg_1_Callback();
                #endif /* CAN_Tx_SEND_MSG_1_CALLBACK */
...
void CAN_Tx_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * FUNCTION NAME:    CAN_Tx_ReceiveMsg1
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    void CAN_Tx_ReceiveMsg1(void) 
    {
        /* `#START MESSAGE_1_RECEIVED` */

        /* `#END` */

        #ifdef CAN_Tx_RECEIVE_MSG_1_CALLBACK
            CAN_Tx_ReceiveMsg_1_Callback();
        #endif /* CAN_Tx_RECEIVE_MSG_1_CALLBACK */
